# TODO some bugs add try command in case of errors
## generate data
...
clusterExport(cl, c("N", "X_formula", "pi_A_Y11", "pi_A_Y12", "pi_A_Y21", "pi_A_Y22", "pi_B1", "pi_B2", "population"))
...
saveRDS(results_simulation1_process, file = "results/ipw.rds")
